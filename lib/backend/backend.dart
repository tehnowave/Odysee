...
import 'schema/travel_record.dart';
...
export 'schema/travel_record.dart';
...
/// Functions to query TravelRecords (as a Stream and as a Future).
Future<int> queryTravelRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
...
Stream<List<TravelRecord>> queryTravelRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      TravelRecord.collection,
      TravelRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<TravelRecord>> queryTravelRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
