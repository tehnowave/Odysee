...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: TravelDetailWidget.routeName,
          path: TravelDetailWidget.routePath,
          builder: (context, params) => TravelDetailWidget(
            travelRef: params.getParam(
              'travelRef',
              ParamType.DocumentReference,
              isList: false,
              collectionNamePath: ['travel'],
            ),
          ),
        ),
        FFRoute(
          name: TravelImagesWidget.routeName,
          path: TravelImagesWidget.routePath,
          builder: (context, params) => TravelImagesWidget(
            travelRef: params.getParam(
              'travelRef',
              ParamType.DocumentReference,
              isList: false,
        ...
        FFRoute(
          name: ChangeInfoWidget.routeName,
          path: ChangeInfoWidget.routePath,
          builder: (context, params) => ChangeInfoWidget(),
        ),
        FFRoute(
          name: Profile3Widget.routeName,
          path: Profile3Widget.routePath,
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'profile3')
              : NavBarPage(
                  initialPage: 'profile3',
                  page: Profile3Widget(),
                ),
        ),
        FFRoute(
        ...
        FFRoute(
          name: AddtravelWidget.routeName,
          path: AddtravelWidget.routePath,
          builder: (context, params) => AddtravelWidget(),
        ),
        FFRoute(
          name: AddPlacePageWidget.routeName,
          path: AddPlacePageWidget.routePath,
          builder: (context, params) => AddPlacePageWidget(),
        )
