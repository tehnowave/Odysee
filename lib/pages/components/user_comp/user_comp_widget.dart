...
import 'user_comp_model.dart';
export 'user_comp_model.dart';

class UserCompWidget extends StatefulWidget {
  const UserCompWidget({
    super.key,
  ...
  @override
  State<UserCompWidget> createState() => _UserCompWidgetState();
}

class _UserCompWidgetState extends State<UserCompWidget> {
  late UserCompModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UserCompModel());
  }
                    ...
                    Padding(
                      ...
                      child: StreamBuilder<List<TravelRecord>>(
                        stream: queryTravelRecord(
                          queryBuilder: (travelRecord) => travelRecord.where(
                            'ownerId',
                          ...
                          return SingleChildScrollView(
                            ...
                            child: Row(
                              ...
                              children: List.generate(
                                  rowTravelRecordList.length, (rowIndex) {
